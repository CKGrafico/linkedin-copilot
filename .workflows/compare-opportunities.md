...
- Note if two opportunities are close enough that the userrs personal preferences should break the tie
...
- Opportunity requiring deeper company research: use rresearcherr (future) or rcompany-scoutr (future)
...
Review if the ranking dimensions become misaligned with the userrs actual decision-making criteria. Update via contributor-request.
