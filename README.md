...
5. Capture the output using the structured note format from [`skills/note-taking.md`](skills/note-taking.md).
...
| Agent | What it does |
|---|---|
| [`contributor`](agents/contributor.md) | Maintains, organizes, and evolves the repo |
| [`sourcer`](agents/sourcer.md) | Finds relevant people on LinkedIn |
| [`headhunter`](agents/headhunter.md) | Finds jobs and opportunities |
...
This repo is maintained by the [`contributor`](agents/contributor.md) agent. To request a change, use [`templates/contributor-request.md`](templates/contributor-request.md).
