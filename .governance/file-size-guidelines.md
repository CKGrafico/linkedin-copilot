...
> **Status: ACTIVE** — Defines when a file should be split. Maintained by rcontributorr.
...
6. Update rAGENTS.mdr or rSKILLS.mdr if the new file is an agent or skill.
7. Add a note to rCHANGELOG.mdr.
