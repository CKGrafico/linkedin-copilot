...
- [opportunity-qualification](../skills/opportunity-qualification.md) — Step 2 (if not already applied)
- [company-research](../skills/company-research.md) — Step 3 (if not already completed)
- [lead-ranking](../skills/lead-ranking.md) — Step 4
- [note-taking](../skills/note-taking.md) — Step 5
