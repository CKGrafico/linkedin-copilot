...
- **Agent:** [sourcer](../agents/sourcer.md)
...
- [person-search](../skills/person-search.md) — Step 3
- [profile-summary](../skills/profile-summary.md) — Step 4
- [lead-ranking](../skills/lead-ranking.md) — Step 5
- [note-taking](../skills/note-taking.md) — Step 7
- [follow-up-planning](../skills/follow-up-planning.md) — Step 8
...
**Agent:** sourcer
**Skill used:** [person-search](../skills/person-search.md)
...
- Priority 1 candidates ready for outreach: pass session note entry to `outreach-writer` (future) with [agents/outreach-writer.md](../agents/outreach-writer.md) + [skills/outreach-drafting.md](../skills/outreach-drafting.md)
- New heuristics or patterns discovered: flag via [templates/contributor-request.md](../templates/contributor-request.md) for [`contributor`](../agents/contributor.md)

---

## Failure Modes

- **Too few results:** Broaden the query in [search-query-design](../skills/search-query-design.md). Consider relaxing geography or domain constraints.
