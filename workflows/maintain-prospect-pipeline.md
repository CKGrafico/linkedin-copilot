...
- **Agent:** [sourcer](../agents/sourcer.md) *(for people pipelines)*
- **Agent:** [headhunter](../agents/headhunter.md) *(for opportunity pipelines)*
...
- [note-taking](../skills/note-taking.md) — Step 1 (reading prior notes)
- [follow-up-planning](../skills/follow-up-planning.md) — Steps 2–4
- [lead-ranking](../skills/lead-ranking.md) — Step 3 (re-prioritization)
